...
mod test {
    ...
    fn empty() {
        let xml = r#"
			<Step index="5" id="13" name="Insert Current Date" enable="True">
				<UUID>960A8BC0-7C06-4E9B-AA8A-67F07707D5E8</UUID>
				<OwnerID></OwnerID>
				<Options>4097</Options>
				<ParameterValues membercount="2">
					<Parameter type="Boolean">
						<Boolean type="Select LKJF" id="4096" value="True"></Boolean>
					</Parameter>
        ...
        let expected_output = Some(
            "Insert Current Date [ Select ; Target: lkjflkjf::creationAccount[123] ]".to_string(),
        );
